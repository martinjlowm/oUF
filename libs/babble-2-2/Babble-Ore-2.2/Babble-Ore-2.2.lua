...
local MINOR_VERSION = 90000 + tonumber(("$Revision: 1320 $"):match("(%d+)"))
...
-- Nodes
	...
	["Cobalt Node"] = true,
	["Rich Cobalt Node"] = true,
	["Saronite Node"] = true,
	["Rich Saronite Node"] = true,
	["Titanium Node"] = true,
...
-- Nodes
	...
	["Cobalt Node"] = "코발트 광맥",
	["Rich Cobalt Node"] = "풍부한 코발트 광맥",
	["Saronite Node"] = "사로나이트 광맥",
	["Rich Saronite Node"] = "풍부한 사로나이트 광맥",
	["Titanium Node"] = "티타늄 광맥",
...
-- Nodes
	...
	["Cobalt Node"] = "钴矿脉",
	["Rich Cobalt Node"] = "富钴矿脉",
	["Saronite Node"] = "萨隆邪铁矿脉",
	["Rich Saronite Node"] = "富萨隆邪铁矿脉",
	["Titanium Node"] = "泰坦神铁矿脉",
...
-- Nodes
	...
	["Cobalt Node"] = "鈷藍礦點",
	["Rich Cobalt Node"] = "豐沃的鈷藍礦點",
	["Saronite Node"] = "薩鋼礦點",
	["Rich Saronite Node"] = "豐沃的薩鋼礦點",
	["Titanium Node"] = "泰坦鋼礦點",
...
-- Nodes
	...
	["Cobalt Node"] = "Залежи кобальта",
	["Rich Cobalt Node"] = "Богатые залежи кобальта",
	["Saronite Node"] = "Месторождение саронита",
	["Rich Saronite Node"] = "Богатое месторождение саронита",
	["Titanium Node"] = "Залежи титана",
